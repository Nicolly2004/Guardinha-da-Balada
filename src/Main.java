...
public class Main {
    ...
    public static void createUser(ArrayList<Usuario> pessoasNaBalada, Scanner scan, Guarda guarda){
        ...
        System.out.println("O usuario é ".concat(usuario.getPronome()).concat(" "+usuario.getGeneroString()));
        ...
        System.out.println("O nome '"+ nomeUser + "' contém a palavra Tigrão? " + nomeUser.contains("Tigrão") + "caracteres.");
        ...
        System.out.println(nome.replace('T', 'L'));
